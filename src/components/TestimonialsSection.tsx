...
const testimonials = [
  {
    ...
    name: "Jelena M.",
    location: "Beograd",
    text: "Oduševljena sam kvalitetom proizvoda! Med koji sam naručila je fantastičan, a komunikacija sa proizvođačem je bila izvanredna.",
    rating: 5,
    product: "Domaći Med",
    avatar: "JM",
    color: "primary",
  },
  {
    ...
    name: "Ana P.",
    location: "Novi Sad",
    text: "Sapuni su neverovatno nežni za kožu. Konačno sam pronašla prirodnu kozmetiku koja mi odgovara. Preporučujem svima!",
    rating: 5,
    product: "Lavanda Sapun",
    avatar: "AP",
    color: "accent",
  },
  {
    ...
    name: "Marko S.",
    location: "Niš",
    text: "Odlična platforma za podršku lokalnim proizvođačima. Svaki proizvod koji sam kupio je premašio moja očekivanja.",
    rating: 5,
    product: "Keramička Šolja",
    avatar: "MS",
    color: "secondary",
  },
];
